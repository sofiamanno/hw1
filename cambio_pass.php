...
<html>
    ...
    <head>
        <meta charset="uttf-8">
        <title>SicilyTravel - Cambia Password</title>
    ...
    <script src="cambio_pass.js" defer></script>
    ...
    <div id="Overlay"></div>
        ...
        <strong>SicilyTravel</strong><br>
                <em>Cambia Password</em>
        </h1>
        
        <section id="signup">
            <form name='dati' method='post'>
                <p>Vecchia Password</p>
                <div><input type="password" name="vecchia_password" id="vecchia_password"></div>
                <span id="errore_vecchia_password" class="errore"></span>
                <br>
                ...
                <div><input type="password" name="password_c" id="password_c"></div>
                <span id="errore_password_c" class="errore"></span>
                <br>
                <br>
